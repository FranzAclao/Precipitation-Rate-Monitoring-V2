...
export function Header({ title = "Precipitation Rate Monitoring System" }) {
  ...
  return (
    <header className="sticky top-0 z-30 flex min-h-[88px] flex-col justify-center gap-4 border-b border-border/60 bg-background px-6 py-3 sm:flex-row sm:items-center sm:justify-between md:top-0 md:min-h-[92px] md:rounded-t-[2rem] md:px-8 lg:px-10">
